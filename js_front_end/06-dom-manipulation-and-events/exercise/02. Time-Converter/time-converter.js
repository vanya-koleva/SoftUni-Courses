...
function solve() {
    ...
    const inputElMin = document.querySelector('#minutes-input');
    const inputElSec = document.querySelector('#seconds-input');
    ...
    function handleSubmitEvent(e) {
        ...
        function updateValues(secondsAmount) {
            ...
            inputElMin.value = Number(secondsAmount / values.minutes).toFixed(2);
            inputElSec.value = Number(secondsAmount / values.seconds).toFixed(2);
        }
    }
}
